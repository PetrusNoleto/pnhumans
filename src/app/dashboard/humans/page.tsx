    ...
    return(
        <AuthenticatedComponent>
            ...
            <main className={"w-full h-full"}>
                <div className={'flex justify-between gap-3 px-12 py-6'}>
                    <span>humanos</span>
                    <button className={'border p-3 rounded-lg'} onClick={()=>{
                ...
                {humanList.length >= 1  ?
                    <></>
                    :
                    <div className={"w-full h-auto p-3 flex justify-center items-center"}>não há humanos</div>
                }
            </main>
        </AuthenticatedComponent>
    )
